        ...
        >
            ...
            <div className={`max-w-4xl w-full flex flex-col md:flex-row gap-12 md:gap-24 items-center md:items-start z-10 mt-8 md:mt-0 smooth-transition delay-100 ${view === 'about' ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}>
                <div className="w-48 h-48 md:w-72 md:h-72 shrink-0 bg-[#12141D] border border-[#1F2833] rounded-none flex items-center justify-center relative overflow-hidden group">
                    ...
                    <span className="font-mono text-[9px] text-[#5C6B73] tracking-[0.4em] uppercase relative z-10 group-hover:text-[#45A29E] transition-colors">NEURAL_ID:ANIMESH</span>
                </div>
                ...
                <div className="flex flex-col border-l border-[#1F2833] pl-10">
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 text-white uppercase flex items-baseline gap-4">
                        About. <span className="text-[10px] font-mono text-[#5C6B73] tracking-[0.5em] animate-pulse">[[ ID_VERIFIED ]]</span>
                    </h1>

...
export const HeroSection: React.FC<HeroSectionProps> = ({ onContactClick }) => {
  ...
  return (
    <section className="relative h-[100dvh] min-h-[100dvh] w-full flex flex-col justify-between overflow-x-clip bg-[#0C0C0C]">
      ...
      {/* Bottom Bar: Bio on left, Contact button on right (Visible on all devices) */}
      <div className="flex flex-row justify-between items-end pb-6 sm:pb-8 md:pb-10 px-5 sm:px-8 md:px-10 w-full z-20 gap-3">
        {/* Left paragraph */}
        <FadeIn delay={0.35} y={20}>
          <p
            className="text-[#D7E2EA] font-light uppercase tracking-wide leading-relaxed max-w-[170px] xs:max-w-[210px] sm:max-w-[240px] md:max-w-[280px] text-[10px] xs:text-xs sm:text-sm md:text-base opacity-90"
          >
